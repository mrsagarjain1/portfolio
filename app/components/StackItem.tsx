  ...
  return (
    <InteractiveSpotlight className="rounded-xl h-full">
      <motion.div
        ...
        className="group p-4 rounded-xl border border-[#222] bg-gradient-to-br from-[#111]/80 to-[#050505]/80 backdrop-blur-md shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] transition-colors hover:border-[#6ee7b7]/40 h-full"
